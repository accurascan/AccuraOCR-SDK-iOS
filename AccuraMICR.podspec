Pod::Spec.new do |spec|
  ...
  spec.source       = { :git => "https://github.com/accurascan/AccuraOCR-SDK-iOS.git", :tag => "4.1.0-MICR" }
  spec.preserve_paths = 'AccuraMICR.framework'
  spec.vendored_frameworks = 'AccuraMICR.framework'
