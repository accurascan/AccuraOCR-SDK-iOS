Pod::Spec.new do |spec|
  ...
  spec.source       = { :git => "https://github.com/accurascan/AccuraOCR-SDK-iOS.git", :tag => "4.1.1-MICR" }
  spec.preserve_paths = 'AccuraMICR.xcframework'
  spec.vendored_frameworks = 'AccuraMICR.xcframework'
