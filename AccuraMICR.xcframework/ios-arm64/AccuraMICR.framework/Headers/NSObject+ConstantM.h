...
FOUNDATION_EXPORT NSString *const ACCURA_ERROR_CODE_KEEP_MICR_IN_FRAME;
FOUNDATION_EXPORT NSString *const ACCURA_ERROR_CODE_MOVE_AWAY;
FOUNDATION_EXPORT NSString *const ACCURA_ERROR_CODE_MOVE_CLOSER;
